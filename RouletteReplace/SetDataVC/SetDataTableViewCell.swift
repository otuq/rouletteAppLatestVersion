...
class SetDataTableViewCell: UITableViewCell {
    ...
    private func rouletteCenterCircleLabel(w: CGFloat) -> UILabel {
        ...
        circleLabel.layer.borderColor = UIColor(r: 255, g: 255, b: 255, a: 0.3).cgColor
        return circleLabel
    }
    // ルーレットの外側円線
    ...
    private func createGraph(data: RouletteData, temporarys: [RouletteGraphTemporary]) {
        ...
        drawRatios.enumerated().forEach { index, ratio in
            ...
            textLabelView.rouletteTextSetting(textString, textColor, textAngle, textSize: CGFloat(10).recalcValue)
